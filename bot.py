...
async def photo_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Если возникла проблема и вас не добавили в течение 12 часов, пожалуйста, свяжитесь с Kirill Finance."
    )
...
async def career_lab(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Этот тариф даёт вам: - доступ к 4-недельному курсу Career Lab... (см. описание)")

async def career_lab_pro(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Career Lab Pro — подробное описание... (см. описание)")
